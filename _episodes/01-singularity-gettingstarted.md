...
Depending on the version of Apptainer installed on your system, you may see a different version. At the time of writing, `v3.5.3`.
...
~~~
{{ site.software.cmd }} inspect -r lolcow_latest.sif | head
~~~
{: .language-bash}
